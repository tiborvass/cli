...
In addition to images, cache can also be pulled from special cache manifests generated by buildx or BuildKit CLI (buildctl). Using these manifests allows to pull in layers for intermediate stages in multi-stage builds.
